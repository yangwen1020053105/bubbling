            ...
            select: function() {
                ...
                y = function(i, u, f,select) {
                    ...
                    if (!u) {
                        ...
                        x.on("click",
                        function() {
                        	for (var z = 0, count = select.options.length; z < count; z++) {       
                               if (select.options[z].getAttribute("value") == this.getAttribute("lay-value")) {
                        	    select.options[z].setAttribute("selected","selected");
                               }else{
                   	            select.options[z].removeAttribute("selected");
                               }
                            }
                        	var index = select.selectedIndex; // 选中索引
                        	var myEvent = new Event('change');
                        	select.dispatchEvent(myEvent);
                            var e = t(this),
                            a = e.attr("lay-value"),
                            n = p.attr("lay-filter");
                ...
                a = function(e, i) {
                    ...
                    function() {
                        ...
                        if($(this).attr("class").indexOf("layui-form-checked")!=-1){
                        	$(this.previousSibling).prop("checked", true);
                        	$(this.previousSibling).change();
                        }else{
                        	$(this.previousSibling).removeAttr("checked");
                        	$(this.previousSibling).change();
                        }
