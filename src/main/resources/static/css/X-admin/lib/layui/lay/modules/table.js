...
//            }))
//        }),
        i.elem.on("click", '.layui-table-header input[name="layTableCheckbox"]+',
        function() {
            var e = t(this).prev(),
            a = i.layBody.find('input[name="layTableCheckbox"]'),
            l = e.parents("tr").eq(0).data("index"),
        ...
        i.elem.on("click", '.layui-table-body tr',
        function() {
        	var radio=$(this).children().find(".layui-form-radio");
        	var checkbox=$(this).children().find(".layui-form-checkbox");
        	if(radio.html()!=null&&radio.html()!=""){
        		radio.addClass("layui-form-radioed");
            	$(this).siblings().children().find(".layui-form-radio").removeClass('layui-form-radioed');
            	$(this).children().find(".layui-anim").addClass("layui-anim-scaleSpring");
            	$(this).children().find(".layui-anim").text("");
            	$(this).siblings().children().find(".layui-anim").removeClass('layui-anim-scaleSpring');
            	$(this).siblings().children().find(".layui-anim").text("");
        		var e = t(radio).prev(),
                a = e[0].checked,
                l = d.cache[i.key],
                n = e.parents("tr").eq(0).data("index");
                ...
                i.setThisRowChecked(n),
                layui.event.call($("."+_+" .layui-form-radio"), y, "radio(" + p + ")", v.call($("."+_+" .layui-form-radio"), {
                    checked: a
                }))
        	}else if(checkbox.html()!=null&&checkbox.html()!=""){
        		var checkInput=$(this).children().find("input[name='layTableCheckbox']");
        		if(checkInput.prop("checked")){
        			checkInput.prop("checked", false);
        		}else{
        			checkInput.prop("checked", true);
        		}
        		var e = t($(this).children().find("input[name='layTableCheckbox']+").get(0)).prev()
        		var a = i.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("index"),
                n = e[0].checked,
                o = "layTableAllChoose" === e.attr("lay-filter");
        		if(n){
        ...
        function() {
            ...
            //杨文20200111修改单选点击行选中
//            if($("."+_+" .layui-form-radio").html()!=null&&$("."+_+" .layui-form-radio").html()!=""){
//            	$("."+_).unbind("click");
//            	$("."+_).click(function() {
////                	$(this).addClass("layui-table-click").siblings().removeClass('layui-table-click');
//                	$("."+_+" .layui-form-radio").addClass("layui-form-radioed");
//                	$(this).siblings().children().find(".layui-form-radio").removeClass('layui-form-radioed');
//                	$("."+_+" .layui-anim").addClass("layui-anim-scaleSpring");
//                	$("."+_+" .layui-anim").text("");
//                	$(this).siblings().children().find(".layui-anim").removeClass('layui-anim-scaleSpring');
//                	$(this).siblings().children().find(".layui-anim").text("");
//            		var e = t($("."+_+" .layui-form-radio")).prev(),
//                    a = e[0].checked,
//                    l = d.cache[i.key],
//                    n = e.parents("tr").eq(0).data("index");
//                    console.log($("."+_+" .layui-form-radio"))
//                    layui.each(l,
//                    function(e, t) {
//                        n === e ? t.LAY_CHECKED = !0 : delete t.LAY_CHECKED
//                    }),
...
//                    
//                })
//            }else if($("."+_+" .layui-form-checkbox").html()!=null&&$("."+_+" .layui-form-checkbox").html()!=""){
//            	$("."+_).unbind("click");
//            	$("."+_).click(function() {
//            		$("."+_).unbind("click");
//            		$("."+_+" input[name='layTableCheckbox']+").click();
//            	});
//            }
