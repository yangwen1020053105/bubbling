...
function(e) {
    ...
    b.prototype.config = {
        ...
        runAdd:true,
        runUpdate:true,
        runDelete:true,//为false时会判断deleteFunction的返回值，返回值为true则继续执行删除操作
        isJump: !1,
        edit: !1,
        text: {
            defaultNodeName: "未命名",
    ...
    b.prototype.spread = function(e, a) {
        ...
        function(i) {
        	//=====杨文20200101修改
        	layui.$(".layui-tree-txt").removeClass("custom-tree-item-clicked");
        	m.children(".layui-tree-txt").addClass("custom-tree-item-clicked");
        	//===================
            var a = e.children("." + v),
    ...
    b.prototype.operate = function(e, a) {
        ...
        function(l) {
            ...
            if ("add" == f) {
                r.addFunction&&r.addFunction(g)//执行回调函数
                if(r.runAdd){
            	...
            	r.updateFunction&&r.updateFunction(g)
            	if(r.runUpdate){
...
function getTreeSelectId(){
	return $(".custom-tree-item-clicked").parent().parent().parent().attr("data-id")
}